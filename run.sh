...
ansible-playbook -i localhost ./ansible/deploy_todo_app.yml -e "bootstrap=$BOOTSTRAP deploy=$DEPLOY" --become || exit-failure "playbook failed to complete successfuly."
